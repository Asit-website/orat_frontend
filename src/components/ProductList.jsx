...
export default function ProductList() {
    ...
    const category_id = queryParameters.get('category_id');
    ...
    const getProductsList = () => {
        ...
        products_list({ offset: 0, category_id: category_id })
            .then((data) => {
                                ...
                                <Link  to="/">
                                    ...
                                    <div className="DynamicHeightLoaderWrapper" style={{ paddingTop: '5%' }}>
                                        <div className="DynamicHeightLoader layout row align-center justify-center" style={{ paddingTop: '20%' }}>
                                            <img src={Productbanner1} alt="logo" className='img-resp DynamicHeightLoaderImage' style={{ padding: '0px' }} />
                                        </div>
                            ...
                            <div className="CategoryHeader layout justify-space-between align-center">
                                <div>
                                    <div className="layout align-center">
                                        ...
                                        <p className="CategoryProductCount h7 font-normal">(116405 products)</p>
                                    </div>
                                </div>
