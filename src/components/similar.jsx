...
function Similar({similarProducts}) {
    var settings = {
        dots: false,
        infinite: true,
        speed: 500,
                                ...
                                <Link   to={`/products/productdetails/${data.id}`} >
                                    ...
                                    <div className="ImageTextDetail ProductImageTextDetail">
                                        ...
                                        <div className="ProductPrice layout row wrap">
                                            <span className='SpecialPrice p2 demi-bold w-auto p-0 detail_spc' style={{ marginLeft: '5%' }}> <i className="fa fa-inr" style={{ fontSize:'13px'}}></i> {formatPrice((data?.saleprice > 0 ? data?.saleprice : data?.price), { showSymbol: false })} </span>
