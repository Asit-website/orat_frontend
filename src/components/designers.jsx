...
import { homedesignerdiscountList } from '../services/Product-service';
import { Link } from 'react-router-dom';


function Designers({showdondis}) {
    ...
    const gethomedesignerdiscountList = () => {
        homedesignerdiscountList().then((data) => {
                                            ...
                                            <div className="CarouselSection category">
                                                ...
                                                <Link to={`/category/?designer_id=${data.id}`}>
                                                        ...
                                                        <div className="ImageTextDetail CategoryImageTextDetail">
                                                            ...
                                                            {/* <label className="h6 ellipsis ImageTextLabelBottom block font-normal">UP TO 25% OFF</label> */}
                                                        </div>
                                                    </Link>
                                                </div>
                                            </div>
