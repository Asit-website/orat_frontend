...
function Fatiz({ designerName, designerProducts }) {
            ...
            <div className='App demo'>
                <div className="BreakPointContainer">
                    <div className="layout row justify-space-between align-center text-left SectionTitle">
                        <h1 className='m-t-0 m-b-0 demi-bold w-auto'> SHOP ALL </h1>
                        <Link to="/category" className='ViewAllUrlsLink link-users orat-color-hover h5 demi-bold w-auto'>VIEW ALL</Link>
                    </div>
                    <Slider className='owl-theme'  {...settingsdd}>
                        {designerProducts?.map((data, index) => (
                            <div className='item' key={index}>
                                <div className="CarouselSection product">
                                    <div className="prel Gutter try_all try_all1">
                                        <Link to={`/products/productdetails/${data.id}`} >
                                            <div className="DynamicHeightLoaderWrapper" style={{ paddingTop: '130%', overflow: 'hidden' }} >
                                                <div className="DynamicHeightLoader layout row align-center justify-center" style={{ paddingTop: '20%' }} onClick={() => { scrollToTop(); }}>
