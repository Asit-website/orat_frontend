    ...
    return (
        loading ? (
            ...
            userInfo ? (
                <>
                    <BrowserView>
                        <div className='App  my-account-mobile'>
                    ...
                    <MobileView>
                        <div className='App other-page-top my-account-mobile mb-4'>
                            <div className="AppContent BreakPointContainer">
                                <div className="MyAccountWrapper prel">
                                        ...
                                        <div className="profile-menu">
                                            ...
                                            <ul className="menu-list">
                                                ...
                                                <li className="menu-item" >
                                                    ...
                                                    <span className="menu-subtext">View/Edit your details</span>
                                                ...
                                                <li className="menu-item">
                                                    ...
                                                    <span className="menu-subtext">View all pending/completed orders</span>
                                                    <span className="menu-arrow"></span>
                                                </li>
                                                </Link>
                                                <Link to="/addaddress">
                                                <li className="menu-item" >
                                                    <span className="menu-text">MANAGE ADDRESSES</span>
                                                    <span className="menu-subtext">View/Edit all your addresses</span>
                                                    <span className="menu-arrow"></span>
                                                </li>
                                                </Link>
                                                <Link to="/wishlist">
                                                <li className="menu-item">
                                                    ...
                                                    <span className="menu-subtext">All your wishlisted products</span>
                                                    <span className="menu-arrow"></span>
                                                </li>
                                                </Link>
                                                <Link onClick={handleLogout}>
                                                <li className="menu-item menus_it">
